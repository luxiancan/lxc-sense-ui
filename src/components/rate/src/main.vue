...
export default {
  ...
  props: {
    ...
    iconClasses: {
      type: [Array, Object],
      default() {
        return ['sense-icon_staroff', 'sense-icon_staroff', 'sense-icon_staroff'];
      }
    },
    voidIconClass: {
      type: String,
      default: 'sense-icon_staron'
    },
    disabledVoidIconClass: {
      type: String,
      default: 'sense-icon_staroff'
    },
    disabled: {
      type: Boolean,
      default: false
  ...
  methods: {
    ...
    showDecimalIcon(item) {
      const showWhenDisabled = this.rateDisabled 
      && this.valueDecimal > 0 
      && item - 1 < this.value 
      && item > this.value;
    ...
    setCurrentValue(value, event) {
      ...
      if (this.allowHalf) {
        ...
        if (hasClass(target, 'ss-rate__item')) {
          target = target.querySelector('sense-icon-search');
        }
        if (hasClass(target, 'ss-rate__decimal')) {
...
<style lang="scss">
@import '@/assets/scss/packages/rate.scss';
</style>
