<template>
  <div class="ss-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <ss-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="ss-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="ss-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
...
<!--        class="ss-time-spinner__wrapper is-arrow">-->
<!--        <i v-repeat-click="decrease" class="ss-time-spinner__arrow ss-icon-arrow-up"></i>-->
<!--        <i v-repeat-click="increase" class="ss-time-spinner__arrow ss-icon-arrow-down"></i>-->
<!--        <ul class="ss-time-spinner__list" ref="hours">-->
<!--          <li-->
<!--            class="ss-time-spinner__item"-->
...
<!--        <i v-repeat-click="decrease" class="ss-time-spinner__arrow ss-icon-arrow-up"></i>-->
<!--        <i v-repeat-click="increase" class="ss-time-spinner__arrow ss-icon-arrow-down"></i>-->
<!--        <ul class="ss-time-spinner__list" ref="minutes">-->
<!--          <li-->
<!--            class="ss-time-spinner__item"-->
...
<!--        <i v-repeat-click="decrease" class="ss-time-spinner__arrow ss-icon-arrow-up"></i>-->
<!--        <i v-repeat-click="increase" class="ss-time-spinner__arrow ss-icon-arrow-down"></i>-->
<!--        <ul class="ss-time-spinner__list" ref="seconds">-->
<!--          <li-->
...
export default {
  ...
  methods: {
    ...
    modifyDateField(type, value) {
      switch (type) {
      case 'hours': this.$emit(
        'change', modifyTime(this.date, value, this.minutes, this.seconds)
      ); break;
      case 'minutes': this.$emit(
        'change', modifyTime(this.date, this.hours, value, this.seconds)
      ); break;
      case 'seconds': this.$emit(
        'change', modifyTime(this.date, this.hours, this.minutes, value)
      ); break;
      default: ''
        break;
      }
    ...
    handleScroll(type) {
      const value = Math.min(Math.round((
        this.$refs[type].wrap.scrollTop -
        (this.scrollBarHeight(type) * 0.5 - 10) /
        this.typeItemHeight(type) + 3) /
        this.typeItemHeight(type)), (type === 'hours' ? 23 : 59));
      this.modifyDateField(type, value);
    },
