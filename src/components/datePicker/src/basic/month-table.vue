<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="ss-month-table">
    <tbody>
...
import {
  arrayFindIndex, coerceTruthyValueToArray, arrayFind
} from '../../../../utils/util';
...
export default {
  ...
  methods: {
    cellMatchesDate(cell, date) {
      ...
      value.getFullYear() && Number(cell.text) ===
      value.getMonth();
    },
    getCellStyle(cell) {
      const style = {};
      ...
      const defaultValue =
      /* eslint-disable */
      this.defaultValue ? Array.isArray(this.defaultValue) ?
