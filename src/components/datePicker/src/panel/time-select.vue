<template>
  ...
  >
    <div
      ...
      :class="popperClass"
      class="ss-picker-panel time-select ss-popper">
      <ss-scrollbar noresize wrap-class="ss-picker-panel__content">
...
import scrollIntoView from '../../../../utils/scrollbar-width';
...
export default {
  ...
  methods: {
    ...
    scrollToOption(selector = '.selected') {
      const menu = this.$refs.popper.querySelector('.ss-picker-panel__content');
