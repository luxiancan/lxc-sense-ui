<template>
  <transition
    ...
    <div
      v-show="visible"
      class="ss-time-range-picker ss-picker-panel ss-popper"
      :class="popperClass">
      <div class="ss-time-range-picker__content">
        <div class="ss-time-range-picker__cell">
          <div class="ss-time-range-picker__header">开始时间</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="ss-time-range-picker__body ss-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="ss-time-range-picker__cell">
          <div class="ss-time-range-picker__header">结束时间</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="ss-time-range-picker__body ss-time-panel__content">
            <time-spinner
      ...
      <div class="ss-time-panel__footer">
        <button
          type="button"
          class="ss-time-panel__btn cancel"
          @click="handleCancel()">取消</button>
        <button
          type="button"
          class="ss-time-panel__btn confirm"
          @click="handleConfirm()"
          :disabled="btnDisabled">确认</button>
      </div>
    </div>
  </transition>
</template>
