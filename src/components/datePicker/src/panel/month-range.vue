          ...
          <div class="ss-picker-panel__content ss-date-range-picker__content is-left">
            <div class="ss-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="ss-picker-panel__icon-btn ss-icon-d-arrow-left"></button>
              <button
                type="button"
                v-if="unlinkPanels"
                @click="leftNextYear"
                ...
                class="ss-picker-panel__icon-btn ss-icon-d-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <month-table
  ...
  watch: {
    ...
    defaultValue(val) {
      if (!Array.isArray(this.value)) {
        ...
        this.leftDate = left;
        this.rightDate = val
        && val[1] && left.getFullYear() !== right.getFullYear() &&
        this.unlinkPanels
          ? right
