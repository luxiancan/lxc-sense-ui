...
export default {
            ...
            >
              {
                columns.map((column, cellIndex) => (<th
                  ...
                  key={ column.id }>
                  <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ?
                    'highlight' :
                    ...
                    }
                    {
                      column.filterable ? (<span
                        class="ss-table__column-filter-trigger"
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.ss-table__column-filter-trigger') || cell;
